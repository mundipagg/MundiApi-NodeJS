...
try {
  const { result, ...httpResponse } = await ordersController.updateOrderStatus(id, request);
...
const bodypayments0PrivateLabel: CreatePrivateLabelPaymentRequest = {};

const bodypayments0: CreatePaymentRequest = {
  paymentMethod: 'payment_method0',
  privateLabel: bodypayments0PrivateLabel,
};

bodyPayments[0] = bodypayments0;

const bodypayments1PrivateLabel: CreatePrivateLabelPaymentRequest = {};

const bodypayments1: CreatePaymentRequest = {
  paymentMethod: 'payment_method9',
  privateLabel: bodypayments1PrivateLabel,
};
