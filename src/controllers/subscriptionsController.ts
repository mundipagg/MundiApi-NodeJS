...
import {
  ...
  getUsagesDetailsResponseSchema,
} from '../models/getUsagesDetailsResponse';
import {
  ListCyclesResponse,
...
export class SubscriptionsController extends BaseController {
   ...
   * @param group           identificador da loja (account) de cada item
   * @return Response from the API call
   */
  async getUsagesDetails(
    ...
    const mapped = req.prepareArgs({
      subscriptionId: [subscriptionId, string()],
      cycleId: [cycleId, optional(string())],
      size: [size, optional(number())],
      page: [page, optional(number())],
      itemId: [itemId, optional(string())],
      group: [group, optional(string())],
    });
    req.query('cycle_id', mapped.cycleId);
    req.query('size', mapped.size);
    req.query('page', mapped.page);
    req.query('item_id', mapped.itemId);
    req.query('group', mapped.group);
    req.appendTemplatePath`/subscriptions/${mapped.subscriptionId}/usages-details/`;
    return req.callAsJson(getUsagesDetailsResponseSchema, requestOptions);
  }
