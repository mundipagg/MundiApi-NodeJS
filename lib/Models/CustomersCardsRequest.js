...
/**
 * Creates an instance of CustomersCardsRequest
 */
class CustomersCardsRequest extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'options', realName: 'options', type: 'Options1' },
...
module.exports = CustomersCardsRequest;
