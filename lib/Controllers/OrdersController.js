...
class OrdersController {
     ...
     * @returns {Promise}
     */
    static deleteAllOrderItems(orderId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/orders/{orderId}/items'}`;
     ...
     * @returns {Promise}
     */
    static updateOrderItem(orderId, itemId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/orders/{orderId}/items/{itemId}'}`;
     ...
     * @returns {Promise}
     */
    static deleteOrderItem(orderId, itemId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createOrderItem(orderId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static updateOrderStatus(id, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/orders/{id}/closed'}`;
