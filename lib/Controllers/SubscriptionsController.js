...
class SubscriptionsController {
    ...
    static getIncrementById(subscriptionId, incrementId, callback) {
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/increments/{increment_id}'}`;
     ...
     * @returns {Promise}
     */
    static updateSubscriptionStartAt(subscriptionId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/start-at'}`;
     ...
     * @returns {Promise}
     */
    static updateSubscriptionAffiliationId(subscriptionId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/gateway-affiliation-id'}`;
    ...
    static getDiscountById(subscriptionId, discountId, callback) {
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/discounts/{discountId}'}`;
     ...
     * @returns {Promise}
     */
    static createIncrement(subscriptionId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/increments'}`;
     ...
     * @returns {Promise}
     */
    static deleteIncrement(subscriptionId, incrementId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
    ...
    static getUsagesDetails(subscriptionId, cycleId, size, page, itemId, group, callback) {
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/usages-details/'}`;
     ...
     * @returns {Promise}
     */
    static updateSubscriptionDueDays(subscriptionId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/boleto-due-days'}`;
     ...
     * @returns {Promise}
     */
    static updateSubscriptionMiniumPrice(subscriptionId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/minimum_price'}`;
     ...
     * @returns {Promise}
     */
    static updateCurrentCycleEndDate(subscriptionId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/cycle-end-date'}`;
     ...
     * @returns {Promise}
     */
    static updateCurrentCycleStatus(subscriptionId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/subscriptions/{subscription_id}/cycle-status'}`;
