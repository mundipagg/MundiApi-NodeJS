...
class InvoicesController {
     ...
     * @param {SubscriptionsCyclesPayRequest} body (optional) TODO: type description here
     *
    ...
    static createInvoice(subscriptionId, cycleId, idempotencyKey, body, callback) {
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                .mapObject(parsed, 'SubscriptionsCyclesPayResponse');
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    let parsed = JSON.parse(_response.body);
                    parsed = _baseController.getObjectMapper()
                .mapObject(parsed, 'SubscriptionsPartialInvoiceResponse');
                    _callback(null, parsed, _context);
                    _fulfill(parsed);
                } else if (_response.statusCode === 400) {
                    const mappedObject = _baseController.getObjectMapper()
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    let parsed = JSON.parse(_response.body);
                    parsed = _baseController.getObjectMapper().mapObject(parsed, 'InvoicesResponse');
                    _callback(null, parsed, _context);
                    _fulfill(parsed);
                } else if (_response.statusCode === 400) {
                    const mappedObject = _baseController.getObjectMapper()
     ...
     * @param {InvoicesMetadataRequest} body Request for updating the invoice metadata
     * @param {string} idempotencyKey (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    let parsed = JSON.parse(_response.body);
                    parsed = _baseController.getObjectMapper().mapObject(parsed, 'InvoicesMetadataResponse');
                    _callback(null, parsed, _context);
                    _fulfill(parsed);
                } else if (_response.statusCode === 400) {
                    const mappedObject = _baseController.getObjectMapper()
     ...
     *
     * @param {string} invoiceId Invoice Id
     * @param {UpdateCurrentCycleStatusRequest} body Request for updating an invoice's status
     * @param {string} idempotencyKey (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    let parsed = JSON.parse(_response.body);
                    parsed = _baseController.getObjectMapper().mapObject(parsed, 'InvoicesStatusResponse');
                    _callback(null, parsed, _context);
                    _fulfill(parsed);
                } else if (_response.statusCode === 400) {
                    const mappedObject = _baseController.getObjectMapper()
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    let parsed = JSON.parse(_response.body);
                    parsed = _baseController.getObjectMapper().mapObject(parsed, 'InvoicesResponse2');
                    _callback(null, parsed, _context);
                    _fulfill(parsed);
                } else if (_response.statusCode === 400) {
                    const mappedObject = _baseController.getObjectMapper()
