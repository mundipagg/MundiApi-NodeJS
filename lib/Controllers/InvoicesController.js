...
class InvoicesController {
     ...
     * @returns {Promise}
     */
    static updateInvoiceStatus(invoiceId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/invoices/{invoice_id}/status'}`;
     ...
     * @returns {Promise}
     */
    static removeInvoiceUsage(invoiceId, usageId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/invoices/{invoice_id}/usages/{usage_id}'}`;
     ...
     * @returns {Promise}
     */
    static removeInvoiceUsages(invoiceId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/invoices/{invoice_id}/usages'}`;
