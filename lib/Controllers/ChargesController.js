...
class ChargesController {
     ...
     * @returns {Promise}
     */
    static updateChargeDueDate(chargeId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/Charges/{charge_id}/due-date'}`;
     ...
     * @returns {Promise}
     */
    static confirmPayment(chargeId, request, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _queryBuilder = `${_baseUri}${'/charges/{charge_id}/confirm-payment'}`;
    ...
    static getChargeTransactions(chargeId, page, size, callback) {
        ...
        let _queryBuilder = `${_baseUri}${'/charges/{charge_id}/transactions'}`;
