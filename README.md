...
![Version Check](https://apidocs.io/illustration/typescript?workspaceFolder=MundiAPI&step=versionCheck)
...
![Resolve Dependencies](https://apidocs.io/illustration/typescript?workspaceFolder=MundiAPI&workspaceName=mundiapilib&step=resolveDependency)
...
- The created project manages its dependencies using its `package.json` file. In order to add a dependency on the *MundiAPILib* client library, double click on the `package.json` file in the bar on the left and add the dependency to the package in it.

![Add Mundiapilib Dependency](https://apidocs.io/illustration/typescript?workspaceFolder=MundiAPI&workspaceName=mundiapilib&step=importDependency)
...
![Install Mundiapilib Dependency](https://apidocs.io/illustration/typescript?step=installDependency)
