...
```javascript
function getCustomers(code, name, document, page, size, email, callback)
```
#### Parameters
...
```javascript
    ...
    controller.getCustomers(code, name, document, page, size, email, function(error, response, context) {
